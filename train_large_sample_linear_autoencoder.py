...
from utils.datasets import VesselGridData, VesselPointCloudData, VesselRelativePointCloudData
...
MODEL_NAME = "large_sample_linear_autoencoder"

# Model Architecture Parameters
SAMPLE_SIZE = 2**12
INPUT_SIZE = 3*SAMPLE_SIZE
HIDDEN_SIZE = [2**11, 2**10, 2**11]
...
def train(args):
    ...
    if GRID64 or GRID128:
        ...
        vessel_dataset = VesselRelativePointCloudData(DATA_PATH, num_samples=SAMPLE_SIZE, transform_function=transform_function)
    else:
